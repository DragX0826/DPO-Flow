# max_flow/utils/physics.py

import torch
import numpy as np
from max_flow.ops.physics_kernels import PhysicsEngine as KernelEngine
...
class PhysicsEngine:
    ...
    def fused_force(self, pL, pP, q_L=None, q_P=None, batch_L=None, batch_P=None, data=None):
        ...
        try:
            import triton
            from max_flow.ops.physics_kernels_v62 import fused_physics_force_triton
