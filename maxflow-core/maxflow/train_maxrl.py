...
from maxflow.data.preference_dataset import PreferenceDataset, preference_collate_fn
from maxflow.models.backbone import CrossGVP
from maxflow.models.flow_matching import RectifiedFlow
from maxflow.models.max_rl import MaxRL
...
def train_maxrl(args):
    ...
    if getattr(args, 'quant_combat', False):
        from maxflow.optimization.schedule_free import HybridSFOAdamW
    ...
    from maxflow.optimization.adaptive_loss import AdaptiveLossWrapper
    from maxflow.optimization.pcgrad import PCGrad
