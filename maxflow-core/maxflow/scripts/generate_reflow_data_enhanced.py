...
from maxflow.utils.metrics import calculate_molecule_quality
...
def generate_reflow_data(
    ...
    from maxflow.utils.verifier import System2Verifier
    from maxflow.utils.metrics import get_mol_from_data
